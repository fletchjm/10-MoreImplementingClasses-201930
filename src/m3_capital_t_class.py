    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        # ---------------------------------------------------------------------
        hcorner1 = rg.Point(intersection_center.x + width / 2,
                            (intersection_center.y - letter_thickness / 2))
        hcorner2 = rg.Point(intersection_center.x - width / 2,
                            (intersection_center.y + letter_thickness / 2))
        self.h_rect = rg.Rectangle(hcorner1, hcorner2)

        vcorner1 = rg.Point(intersection_center.x + letter_thickness / 2,
                            intersection_center.y - letter_thickness / 2)
        vcorner2 = rg.Point(intersection_center.x - letter_thickness / 2,
