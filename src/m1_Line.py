...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.times_clone = 0
        self.startpoint = start.clone()
        self.endpoint = end.clone()
    ...
    def clone(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        self.times_clone = self.times_clone + 1
    ...
    def length(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        distancex = (self.end.x - self.start.x)
        distancey = (self.end.y - self.start.y)
        distance = (distancey ** 2 + distancex ** 2) ** .5
        return distance
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        sumstartx = self.start.x + other_line.start.x
        sumendx = self.end.x + other_line.end.x
        sumstarty = self.start.y + other_line.start.y
        sumendy = self.end.y + other_line.end.y

        return Line(Point(sumstartx, sumstarty),Point(sumendx, sumendy))
    ...
    def midpoint(self):
        ...
        distancex = (self.end.x - self.start.x)
        distancey = (self.end.y - self.start.y)
        midpoint = Point(distancex / 2 + self.start.x, distancey / 2 +
                         self.start.y)
        return midpoint
